 ...
 */
/*function imaudit_db_upgrade_1() {
}
function imaudit_db_upgrade_2() {
}*/

function xoops_module_update_imaudit($module) {
	/**
...
function xoops_module_install_imaudit($module) {
