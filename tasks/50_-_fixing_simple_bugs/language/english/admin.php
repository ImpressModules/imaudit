...
// Requirements
define("_AM_IMAUDIT_REQUIREMENTS", "imAudit Requirements");
define("_AM_IMAUDIT_REQUIREMENTS_INFO", "We've reviewed your system, unfortunately it doesn't meet all the requirements needed for imAudit to function. Below are the requirements needed.");
define("_AM_IMAUDIT_REQUIREMENTS_ICMS_BUILD", "imAudit requires at least ImpressCMS 1.1.1 RC 1.");
define("_AM_IMAUDIT_REQUIREMENTS_SUPPORT", "Should you have any question or concerns, please visit our forums at <a href='http://community.impresscms.org'>http://community.impresscms.org</a>.");

// general
define("_AM_IMAUDIT_FIRST_USE", "This is the first time you access this module. Please update the module in order to dynamically create the database scheme.");
...
define("_AM_IMAUDIT_CHANGESET_VIEW_DSC", "Here is the info about this changeset.");// Review
...
define("_AM_IMAUDIT_REVIEW_VIEW_DSC", "Here is the info about this review.");
...
define("_AM_IMAUDIT_BRANCH_VIEW_DSC", "Here is the info about this branch.");
define("_AM_IMAUDIT_BRANCH_UPDATE", "Update changesets of the branch with the latest from the RSS Feed");
?>